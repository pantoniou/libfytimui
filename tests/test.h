...
/* Local-only core deltas (docs/vendor-deltas.md); see test_mouse_drag.c. */
void test_mouse_without_drag_emits_no_1002(void);
void test_mouse_drag_emits_1002(void);
void test_mouse_drag_disabled_on_exit(void);
void test_mouse_drag_alone_is_inert(void);
void test_transport_accessor(void);
void test_mouse_state_accessor(void);

/* Local-only inline band mode (docs/vendor-deltas.md); see test_inline.c. */
...
/* Local-only cases outside the inline/mouse files; see test_local_core.c. */
